    ...
    <div>
      <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
                <label htmlFor="email" className="block text-sm/6 font-medium text-gray-100">Matricule</label>
                <div className="mt-2">
                <input id="email" type="email" name="email" required autoComplete="email" className="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-500 transition-all duration-200 focus:shadow-ls focus:shadow-blue-700 sm:text-sm/6" />
                </div>
            </div>

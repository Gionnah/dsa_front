  ...
  return (
    <div className='w-full px-4'>
        <div className="option flex items-end justify-between">
            <div className="select text-white py-2">
            ...
            <button className="flex items-center justify-center gap-2 px-3 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition">
        ...
        <p className='my-2 text-gray-200'>Output: </p>
        <div className="h-[30vh] w-full shadow-inner shadow-black bg-neutral-800 border border-gray-900 mt-2 rounded-lg p-4 text-sm text-green-400 font-mono overflow-y-auto">
            {/* Console Output Area */}
        </div>
        <p className='my-2 text-gray-200'>Test: </p>
        <div className="h-[30vh] w-full shadow-inner shadow-black bg-neutral-800/30 border border-gray-900 mt-2 rounded-lg p-4 text-sm text-green-400 font-mono overflow-y-auto">
        {/* Console Output Area */}
        </div>
    </div>
  )

...
function AvatarSkeleton() {
  return (
    <div className="w-14 h-14 md:w-20 md:h-20 rounded-full bg-slate-300 animate-pulse"></div>
  );
}

function TextSkeleton({ width = "w-32", height = "h-4" }: { width?: string; height?: string }) {
  return (
...
function StatCardSkeleton() {
  return (
    <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-4">
      <div className="w-full h-32 bg-slate-100 rounded-lg animate-pulse"></div>
    </div>
  );
}
...
function ImageModal({ src, alt, onClose }: { src: string; alt: string; onClose: () => void }) {
  ...
  return (
    <div 
      className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center p-4 font-mono animate-in fade-in duration-200"
      style={{ zIndex: 9999 }}
      onClick={onClose}
    >
      <div 
                        ...
                        <div className="bg-slate-700 relative shadow-sm p-4 md:p-6">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3 md:gap-4">
                                    <AvatarSkeleton />
                                    <div className="space-y-2">
                                        <TextSkeleton width="w-40" height="h-5" />
                                        <TextSkeleton width="w-24" height="h-3" />
                                    </div>
                                </div>
                                <div className="w-16 h-16 md:w-24 md:h-24 rounded-full bg-slate-600/50 animate-pulse"></div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-4 md:space-y-6">
                                ...
                                <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg shadow-sm border border-amber-200 p-3 md:p-4">
                                    <div className="flex items-center gap-2 mb-2">
                                        <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-amber-200 animate-pulse"></div>
                                        <div className="space-y-1">
                                            <div className="h-3 bg-amber-300 rounded w-16 animate-pulse"></div>
                                            <div className="h-5 bg-amber-300 rounded w-12 animate-pulse"></div>
                                        </div>
                                    </div>
                                    <div className="w-full h-1.5 bg-white rounded-full overflow-hidden mb-1.5">
                                        <div className="w-1/3 h-full bg-amber-400 rounded-full animate-pulse"></div>
                                    </div>
                                    <div className="h-3 bg-amber-200 rounded w-32 mx-auto animate-pulse"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    return (
        <HomeLayout>
            <div className="min-h-screen bg-indigo-50 rounded-lg w-full font-mono">
                ...
                <div className="space-y-4 md:space-y-6 duration-500">
                    {/* Header Compact */}
                        ...
                        <div className="flex items-center justify-between">
                                ...
                                {getUserAvatar() ? (
                                    ...
                                    >
                                        <img
                                            src={getUserAvatar()!}
                                            alt={getUserFullName()}
                                            className="w-14 h-14 md:w-20 md:h-20 rounded-full object-cover border-4 border-white shadow-md transition-all duration-300 group-hover:scale-110 group-hover:rotate-3"
                                        ...
                                        <div className="absolute inset-0 rounded-full bg-black/0 group-hover:bg-black/20 transition-all duration-200 flex items-center justify-center">
                                            <svg className="w-4 h-4 md:w-6 md:h-6 text-white opacity-0 group-hover:opacity-100 transition-all duration-200 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                                            </svg>
                                        </div>
                                    </div>
                                ) : (
                                    <div className="w-14 h-14 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center text-white text-lg md:text-2xl font-bold shadow-md duration-300">
                                        {getUserInitials()}
                                    </div>
                                )}
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center">
                                    <Trophy className="w-3 h-3 md:w-5 md:h-5 mb-0.5 animate-pulse" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 px-3 md:px-4">
                                ...
                                <div className="p-4 md:p-5">
                                    {getCurrentChallenge() ? (
                                        <div className="space-y-3 md:space-y-4">                                            
                                            <div className="bg-slate-50 rounded-lg p-3 md:p-4 border border-slate-200 hover:border-blue-200 transition-colors duration-200">
                                                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-2">
                                                    <h3 className="text-lg md:text-xl font-bold text-slate-900">
                                                        {getCurrentChallenge()?.challenge_title || 'Unknown Challenge'}
                                                    </h3>
                                                    <span className="text-xs font-bold text-blue-600 animate-in fade-in duration-500">{Math.min((getCurrentChallenge()?.attempts_count || 0) * 20, 100)}%</span>
                                                </div>
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg p-3 md:p-4 border border-amber-200 hover:shadow-sm transition-all duration-200 hover:scale-[1.02]">
                                                ...
                                                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-3 md:p-4 border border-blue-200 hover:shadow-sm transition-all duration-200 hover:scale-[1.02]">
                                                    <div className="flex items-center gap-1.5 mb-1">
                                            ...
                                            <button onClick={() => {}} className="w-full px-4 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 ease-in-out duration-300 text-white rounded-md font-semibold hover:shadow-md transition-all flex items-center justify-center gap-2 group text-sm cursor-not-allowed">
                                                Continue challenge
                                        ...
                                        <div className="text-center py-6 md:py-8">
                                            <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-slate-100 flex items-center justify-center mx-auto mb-2 group-hover:scale-110 transition-transform duration-300">
                                            ...
                                            <Link href={`/members/challenges`} className="inline-block px-5 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white rounded-md font-semibold hover:shadow-md transition-all duration-300 text-xs hover:scale-105">
                                                Discover challenges
                                            </Link>
                                        </div>
                                    )}
                            ...
                            <div className="bg-white rounded-lg shadow-sm border border-slate-200 hover:shadow-md transition-shadow duration-300">
                                ...
                                <div className="p-4 md:p-5">
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-3">
                                        <div className="text-center p-2.5 bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg border border-green-200 hover:scale-105 transition-transform duration-200">
                                        ...
                                        <div className="text-center p-2.5 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg border border-blue-200 hover:scale-105 transition-transform duration-200">
                                        ...
                                        <div className="text-center p-2.5 bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg border border-purple-200 hover:scale-105 transition-transform duration-200">
                                    ...
                                    <div className="bg-slate-50 rounded-lg p-3 border border-slate-200 hover:bg-slate-100 transition-colors duration-200">
                        ...
                        <div className="space-y-4 md:space-y-6">
                                ...
                                <div className="p-3 md:p-4">                                    
                                    <div className="space-y-2">
                                        {recentChallenges.length > 0 ? (
                                            recentChallenges.map((challenge: any, index: number) => (
                                                <div 
                                                    key={challenge.id} 
                                                    className="bg-slate-50 rounded-md p-2.5 border border-slate-200 hover:border-slate-300 hover:shadow-sm transition-all duration-200 hover:scale-[1.02]"
                            ...
                            {/* Ranking Info */}
                            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg shadow-sm border border-amber-200 p-3 md:p-4 hover:shadow-md transition-all duration-300 hover:scale-[1.01]">
                                <div className="flex items-center gap-2 mb-2">

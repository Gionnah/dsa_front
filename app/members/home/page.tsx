                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3 md:gap-4">
                                ...
                                <div className="text-white">
                                    ...
                                    <p className="text-slate-200 text-xs md:text-sm">@{userDetails?.stat?.user?.username || 'username'}</p>
                                </div>
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center">
                                    <Trophy className={`w-4 h-4 md:w-6 md:h-6 mb-1 transition-colors duration-300`} />
                                    <span className={`text-xs md:text-sm font-bold transition-colors duration-300`}>
                                        #{userDetails?.stat?.ranking?.global_rank || 1}
                                    </span>
                                    <span className={`text-xs text-slate-200 font-medium transition-colors duration-300`}>
                                        Global Rank
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-slate-200">
                                <div className="border-b border-slate-200 px-4 md:px-6 py-3 md:py-4">
                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                        ...
                                        {getCurrentChallenge() && (
                                            <span className="text-xs md:text-sm text-slate-500">Started on {getCurrentChallenge()?.started_at ? formatDate(getCurrentChallenge().started_at) : 'N/A'}</span>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className="p-4 md:p-6">
                                    {getCurrentChallenge() ? (
                                            ...
                                            <div className="bg-slate-50 rounded-lg p-4 md:p-5 border border-slate-200">
                                                ...
                                                <div>
                                                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                                                        <span className="inline-block px-3 py-1 md:px-4 md:py-1.5 rounded-lg text-xs md:text-sm font-semibold bg-blue-100 text-blue-700 border border-blue-200">
                                                        ...
                                                        <span className="text-slate-600 text-xs md:text-sm font-medium">{getCurrentChallenge()?.attempts_count || 0} Attempts</span>
                                                    </div>
                                                </div>
                                            </div>
                                            
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                                                <div className="bg-linear-to-br from-amber-50 to-orange-50 rounded-lg p-4 md:p-5 border border-amber-200">
                                                ...
                                                <div className="bg-linear-to-br from-blue-50 to-indigo-50 rounded-lg p-4 md:p-5 border border-blue-200">
                                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <div className="text-center py-8 md:py-12">
                                            ...
                                            <h3 className="text-lg md:text-xl font-bold text-slate-900 mb-2">No current challenge</h3>
                                            ...
                                            <Link href={`/members/challenges`} className="px-6 py-3 md:px-8 md:py-3.5 bg-linear-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-semibold hover:shadow-lg transition-all text-xs lg:text-sm md:text-base">
                                ...
                                <div className="p-4 md:p-6">
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 mb-4 md:mb-6">
                                        <div className="text-center p-3 md:p-4 bg-linear-to-br from-green-50 to-emerald-50 rounded-lg border border-green-200">
                                            <p className="text-2xl md:text-4xl font-bold text-slate-900 mb-1">{userDetails?.stat?.challenges?.completed || 0}</p>
                                            <p className="text-xs md:text-sm font-semibold text-slate-600">Challenges completed</p>
                                        </div>
                                        <div className="text-center p-3 md:p-4 bg-linear-to-br from-blue-50 to-cyan-50 rounded-lg border border-blue-200">
                                            <p className="text-2xl md:text-4xl font-bold text-slate-900 mb-1">{userDetails?.stat?.challenges?.in_progress || 0}</p>
                                        ...
                                        <div className="text-center p-3 md:p-4 bg-linear-to-br from-purple-50 to-pink-50 rounded-lg border border-purple-200">
                                            <p className="text-2xl md:text-4xl font-bold text-slate-900 mb-1">{userDetails?.stat?.challenges?.completion_rate || 0}%</p>
                        ...
                        <div className="space-y-4 md:space-y-6">
                                    ...
                                    <div className="space-y-3">
                                        {recentChallenges.length > 0 ? (
                                            recentChallenges.map((challenge: any) => (
                                                <div 
                                                    key={challenge.id} 
                                                    className="bg-slate-50 rounded-lg p-3 md:p-4 border border-slate-200 hover:border-slate-300 hover:shadow-sm transition-all"
                                                >
                                                    ...
                                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-xs mt-2 md:mt-3 pt-2 md:pt-3 border-t border-slate-200">
                                                        <div className="flex items-center gap-3 md:gap-4">
                                                        ...
                                                        <span className="px-2 py-1 rounded bg-white text-slate-600 border border-slate-200 font-semibold text-xs">
                                            ...
                                            <div className="text-center py-6 md:py-8">
                                                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-slate-100 flex items-center justify-center mx-auto mb-2 md:mb-3">
                                                    <Award className="w-5 h-5 md:w-6 md:h-6 text-slate-400" />
                                                </div>
                                                <p className="text-slate-500 text-xs md:text-sm">No recent activity</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                            ...
                            <div className="bg-linear-to-br from-amber-50 to-orange-50 rounded-xl shadow-sm border border-amber-200 p-4 md:p-6">
                                <div className="flex items-center gap-3 mb-3 md:mb-4">
                                    ...
                                    <div>
                                        <p className="text-xs md:text-sm font-semibold text-slate-700">Your ranking</p>
                                        <p className="text-xl md:text-2xl font-bold text-slate-900">#{userDetails?.stat?.ranking?.global_rank || 1}</p>
                                    </div>
                                </div>
